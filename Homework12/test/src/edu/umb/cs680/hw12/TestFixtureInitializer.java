...
public class TestFixtureInitializer {
    public static APFS createAPFS() {
        ...
        ApfsDirectory applications = new ApfsDirectory(root, "applications", 2, time2, "userApplications", time3);
        ApfsDirectory home = new ApfsDirectory(root, "home", 3, time2, "user2Home", time4);
        ...
        ApfsFile d = new ApfsFile(code, "d", 11, time1, "userD", time5);
