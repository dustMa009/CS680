...
public class AlphabeticalComparatorTest {
    ...
    public void appendChildTest() {
        ...
        int i = 0;
        for (ApfsElement e : root.getChildren(new AlphabeticalComparator<>())) {
            assertSame(old_children[i], e);
            i++;
        }
        assertEquals(2, root.getChildren(new AlphabeticalComparator<>()).size());
        root.appendChild(f);
        i = 0;
        for (ApfsElement e : root.getChildren(new AlphabeticalComparator<>())) {
        ...
        assertEquals(3, root.getChildren(new AlphabeticalComparator<>()).size());
        root.removeChild(f);
        i = 0;
        for (ApfsElement e : root.getChildren(new AlphabeticalComparator<>())) {
            assertSame(old_children[i], e);
    ...
    public void getChildrenTest() {
        ...
        int i = 0;
        for (ApfsElement e : code.getChildren(new AlphabeticalComparator<>())) {
            assertSame(expected[i], e);
            i++;
        }
        assertEquals(3, code.getChildren(new AlphabeticalComparator<>()).size());
    }
    ...
    public void getSubDirectoriesTest() {
        ...
        int i = 0;
        for (ApfsElement e : home.getSubDirectories(new AlphabeticalComparator<>())) {
            assertSame(expected[i], e);
            i++;
        }
        assertEquals(1, home.getSubDirectories(new AlphabeticalComparator<>()).size());
    }
    ...
    public void getFilesTest() {
        ...
        int i = 0;
        for (ApfsElement e : code.getFiles(new AlphabeticalComparator<>())) {
            assertSame(expected[i], e);
            i++;
        }
        assertEquals(2, code.getFiles(new AlphabeticalComparator<>()).size());
    }
}
