...
public class YearComparatorTest {
    ...
    public static void setUp() {
        car1 = new Car("ModelA", "make5", 1000, 2012, 9000.5f);
    ...
    @Test
    public void sortWithYearLambda() {
        Car[] expected = {car5, car3, car1, car2, car4};
        int i = 0;
        Collections.sort(usedCars, (Car car1, Car car2) -> car1.getYear() - car2.getYear());
        for (Car c : usedCars) {
    ...
    @Test
    public void sortWithYearReverse() {
        Car[] expected = {car4, car2, car1, car3, car5};
        usedCars.clear();
        usedCars.add(car1);
        usedCars.add(car2);
        usedCars.add(car3);
