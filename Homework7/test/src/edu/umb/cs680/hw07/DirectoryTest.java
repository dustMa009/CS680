...
public class DirectoryTest {
    ...
    public void appendChildrenTestOnCode() {
        ...
        File c = (File)code.getChildren().get(0);
        Directory photos = new Directory(code, "photos", 9, time);
        FSElement[] expected_before = {c, d};
        FSElement[] expected_after = {c, d, photos};
        int i = 0;
    ...
    public void removeChildTestOnHome() {
        ...
        FSElement[] expected_before = {code, b, car};
        FSElement[] expected_after = {code, b};
